-- Recrear stored procedure para listar aplicaciones
-- Primero eliminar la función existente y luego recrearla con la estructura correcta

-- Eliminar función existente si existe
DROP FUNCTION IF EXISTS public.sp_aplicaciones_listar();
