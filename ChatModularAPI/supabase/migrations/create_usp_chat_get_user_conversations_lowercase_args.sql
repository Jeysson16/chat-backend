-- Crea/actualiza la función de listado de conversaciones por usuario usando tablas chat en snake_case
-- Argumentos en minúsculas para compatibilidad con PostgREST
