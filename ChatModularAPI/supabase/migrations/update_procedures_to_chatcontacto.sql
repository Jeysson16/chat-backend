-- Update stored procedures to use chatcontacto table instead of chatcontactos
-- This matches what the backend is expecting
...
-- Create updated procedures using chatcontacto table
...
BEGIN
    ...
    FROM chatcontacto c  -- Changed from chatcontactos to chatcontacto
...
-- Updated procedure for pending requests
...
BEGIN
    ...
    FROM chatcontacto s  -- Changed from chatcontactos to chatcontacto
