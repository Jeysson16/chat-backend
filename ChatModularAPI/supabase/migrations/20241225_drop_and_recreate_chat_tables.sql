-- Migration: Drop existing tables and recreate with correct nomenclature
-- Date: 2024-12-25
-- Description: Drops all existing chat tables and recreates them with proper field prefixes
