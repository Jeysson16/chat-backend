-- Recreate sp_aplicaciones_crear to target unified ConfiguracionAplicacion schema
...
BEGIN
    ...
    -- Ensure unified configuration row exists (defaults will populate)
    v_nConfiguracionesCreadas := 0;
    INSERT INTO "ConfiguracionAplicacion" ("nAplicacionesId")
    VALUES (v_nAplicacionesId)
    ON CONFLICT ("nAplicacionesId") DO NOTHING;
    v_nConfiguracionesCreadas := 1;
