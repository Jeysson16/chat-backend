...
-- Fecha: 2025-01-01
-- Descripción: Reemplaza la estructura clave-valor por una estructura unificada con columnas específicas

-- Crear tabla temporal para backup de datos existentes
CREATE TABLE ConfiguracionAplicacion_backup AS 
SELECT * FROM "ConfiguracionAplicacion";

-- Renombrar tabla existente en lugar de eliminarla
ALTER TABLE "ConfiguracionAplicacion" RENAME TO "ConfiguracionAplicacion_old";

-- Crear nueva tabla ConfiguracionAplicacion con estructura unificada
...
-- Insertar configuración por defecto para aplicaciones existentes
