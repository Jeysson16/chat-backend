-- Recrear función usando tablas antiguas PascalCase (Conversaciones/Participantes/Usuarios/Mensajes)
-- Sin dependencia de columna AppCodigo; se devuelve el parámetro cappcodigo como app de salida
...
IS 'Lista conversaciones por usuario desde Participantes con join a Usuarios; columnas snake_case para consumo API. (Tablas antiguas PascalCase)';
