-- Eliminar función existente y recrear sp_aplicaciones_crear con parámetros correctos
...
-- Crear stored procedure para crear aplicaciones con nombres de parámetros exactos
